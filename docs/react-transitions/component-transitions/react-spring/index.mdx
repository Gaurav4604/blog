...
[Learn about setting up a React Application](https://create-react-app.dev/docs/getting-started/#creating-a-typescript-app)
...
- extending on the logic of [recipe 4](./recipe-4) we optimize our dismissibles, to be atomic components, that can be reused inside
  a list. While doing so, we're also going to take a look at how to smoothly animated them, in and out from the DOM tree, in the form of a list item.
